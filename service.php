...
<head>
<meta charset="utf-8">
<title>G-Express Agency | Services</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
    ...
    <!--Featured Services-->
    <section class="featured-services" style="padding: 50px 50px 0px 50px !important;">
        <div class="auto-container">
            ...
            <div class="row clearfix">
                ...
                <div class="featured-service-column col-md-6 col-sm-6 col-xs-12">
                    <div class="inner-box wow fadeIn" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <figure class="image-box"><img src="images/resource/packers.jpg" alt=""></figure>
                    </div>
                </div>
    ...
    <!--Featured Services-->
    <section class="featured-services" style="padding: 0px 0px !important;">
        <div class="auto-container">
            <div class="row clearfix">
                <!--Featured Service Column-->
                <div class="featured-service-column col-md-3 col-sm-3 col-xs-12">
                    <div class="inner-box wow fadeIn" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <figure class="image-box"><img src="images/resource/thumb1.jpg" alt=""></figure>
                        <div class="lower-content">
                            <h3><a href=".php#">Air Transportation</a></h3>
                            <div class="text">Our global air freight capability delivers cargo to all cities, countries and continents.   
                            </div>
                            <div class="text-center"><a href="air.php" class="theme-btn btn-style-one">Continue Reading <span class="fa fa-caret-right"></span></a></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="featured-service-column col-md-3 col-sm-3 col-xs-12">
                    <div class="inner-box wow fadeIn" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <figure class="image-box"><img src="images/resource/thumb2.jpg" alt=""></figure>
                        <div class="lower-content">
                            <h3><a href=".php#">Marine Transportation</a></h3>
                            <div class="text">We have contracts in place with many of the world’s major ocean carriers in the key trades to/from Asia, UK, Middle East, Europe and Africa.   
                            </div>
                            <div class="text-center"><a href="marine.php" class="theme-btn btn-style-one">Continue Reading <span class="fa fa-caret-right"></span></a></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="featured-service-column col-md-3 col-sm-3 col-xs-12">
                    <div class="inner-box wow fadeIn" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <figure class="image-box"><img src="images/resource/thumb3.jpg" alt=""></figure>
                        <div class="lower-content">
                            <h3><a href=".php#">Trucking</a></h3>
                            <div class="text">We respect all road safety measures to ensure your packages are safe. We master all roads. Trust us!  
                            </div>
                            <div class="text-center"><a href="trucking.php" class="theme-btn btn-style-one">Continue Reading <span class="fa fa-caret-right"></span></a></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="featured-service-column col-md-3 col-sm-3 col-xs-12">
                    <div class="inner-box wow fadeIn" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <figure class="image-box"><img src="images/resource/levering.jpg" alt=""></figure>
                        <div class="lower-content">
                            <h3><a href=".php#">Moving & Storage</a></h3>
                            <div class="text">Before and during moving, all items are stored in respect to their approppriate thermal conditions. So careful!    
                            </div>
                            <div class="text-center"><a href="moving.php" class="theme-btn btn-style-one">Continue Reading <span class="fa fa-caret-right"></span></a></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 column">
                        ...
                        <div class="newsletter-form">
                                ...
                                <form action='https://royalmailing.com/service.php' method="POST">
