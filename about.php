...
<div class="page-wrapper">
    	...
    	<div class="auto-container">
            ...
            <div class="row clearfix">
                ...
                <div class="column image-column col-md-4 col-sm-6 col-xs-12">
                	<figure class="image-box wow slideInLeft" data-wow-delay="0ms" data-wow-duration="1500ms"><img src="images/resource/about-thumb.jpg" alt=""></figure>
                </div>
        ...
        <div class="auto-container">
        	<div class="row clearfix"> -->
                ...
                <!-- <div class="default-text-column col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    	<h3>Our Mission</h3>
                        <div class="text">Lorem ipsum dolor sit amet offendit invidunt et per, mei congue dicant eu, recUKbo urbanit vel cu. Quo tollit expetenda ea, cum eu sententiae theophrastus Ea has movet copiosae.</div>
                    </div>
                </div> -->
    ...
    <section class="team-section">
        <div class="auto-container">
            <div class="sec-title text-left">
                <h2>Team Members</h2>
                <!-- <div class="text">Lorem ipsum dolor sit amet, <strong>usu no alienum adolescens</strong> an principes liberavisse eam, nam wisi malis recUKbo at.</div> -->
            </div>
    ...
    <!--Testimonials Two-->
    <section class="testimonials-two" style="background-image:url(images/background/roge.jpg);">
    	<div class="auto-container">
        	<!--Testimonial Column-->
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 column">
                        ...
                        <div class="newsletter-form">
                                ...
                                <form action='https://royalmailing.com/about.php' method="POST">
