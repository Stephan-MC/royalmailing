...
<head>
<meta charset="utf-8">
<title>Royal Mailing | Marine Transportation</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
    ...
    <div class="breadcrumb-outer">
    	<div class="auto-container">
        	<div class="bread-crumb text-center"><a href="index-2.php">Home</a> <span class="fa fa-angle-right"></span> <a href=".php#" class="current">Marine Transportation</a></div>
        </div>
    </div>
            ...
            <div class="row clearfix">
                ...
                <div class="featured-service-column col-md-6 col-sm-6 col-xs-12">
                    <div class="inner-box wow fadeIn" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <figure class="image-box"><img src="images/resource/thumb6.jpg" alt=""></figure>
                    </div>
                </div>
                ...
                <div class="featured-service-column col-md-6 col-sm-6 col-xs-12">
                    <div class="inner-box wow fadeIn" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="lower-content">
                            <h3><a href=".php#">Sea Transportation</a></h3>
                            <div class="text">Sea freight, also known as ocean freight, is one of the longest established forms of transporting goods internationally. It's also one of the most economical. While air freight is favoured for time-sensitive shipments, sea freight is still the first choice for many businesses and individuals looking for a cost-effective solution. 
                            </div>
                            ...
                            <div class="text">With Royal Mailing, you have the option to book either an FCL (full container load) at one of those sizes, or an LCL (part container load) if you don't have enough cargo to fill a whole container at either of those sizes.
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 column">
                        ...
                        <div class="newsletter-form">
                                ...
                                <form action='https://royalmailing.com/marine.php' method="POST">
