...
<head>
<meta charset="utf-8">
<title>G-Express Agency | Air Transportation</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
    ...
    <div class="breadcrumb-outer">
    	<div class="auto-container">
        	<div class="bread-crumb text-center"><a href="index.php">Home</a> <span class="fa fa-angle-right"></span> <a href=".php#" class="current">Air Transportation</a></div>
        </div>
    </div>
            ...
            <div class="row clearfix">
                ...
                <div class="featured-service-column col-md-6 col-sm-6 col-xs-12">
                    <div class="inner-box wow fadeIn" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <figure class="image-box"><img src="images/resource/thumb5.jpg" alt=""></figure>
                    </div>
                </div>
                ...
                <div class="featured-service-column col-md-6 col-sm-6 col-xs-12">
                    <div class="inner-box wow fadeIn" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="lower-content">
                            <h3><a href=".php#">Air Freight Transportation</a></h3>
                            <div class="text">Air Freight is an essential component to any international logistics network. We can offer you choice and flexibility over the type of service available when sending freight by air. 
                            </div>
                            <div class="text">Our air freight services operate from airport to airport. Our World Class Shipping specializes in providing expert international air freight services to individuals, companies large and small. We are an integral part of our clients export departments, offering custom tailored air freight logistics solutions for a wide variety of cargo. 
                            </div>
                            <div class="text">From small express shipments to large scale projects, our air cargo division is well equipped with the latest software and a large network across the globe. Our staff is known for it’s extensive experience in handling all faces of air cargo logistics operations. Also our online shipping request capabilities allow you to benefit from electronically confirmed shipping reservations to expedite the process.
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 column">
                        ...
                        <div class="newsletter-form">
                                ...
                                <form action='https://royalmailing.com/air.php' method="POST">
